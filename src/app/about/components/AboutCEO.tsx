...
const VisionIcon = () => (
  ...
  >
    ...
    <path
      ...
      fill="url(#v1)"
    />
    <path d="M24.3049 0H27.2934V5.9769H24.3049V0Z" fill="url(#v2)" />
    <path
    ...
    <defs>
      {[
        ...
        { id: "v3", x1: "16.4123", y1: "4.356", x2: "13.5822", y2: "5.31529" },
        {
          id: "v4",
          x1: "6.61072",
          y1: "8.73507",
        ...
        { id: "v6", x1: "30.282", y1: "20.9191", x2: "21.3167", y2: "20.9191" },
      ].map(({ id, x1, y1, x2, y2 }) => (
        <linearGradient
          key={id}
          id={id}
  ...
  >
    ...
    <defs>
      {[
        ...
        { id: "f2", x1: "51.289", y1: "23.2696", x2: "4.74988", y2: "23.2696" },
        { id: "f3", x1: "23.451", y1: "46.3904", x2: "14.4983", y2: "46.3904" },
        {
          id: "f4",
          x1: "9.25387",
          y1: "32.1935",
        ...
        { id: "f5", x1: "12.2904", y1: "43.343", x2: "3.33765", y2: "43.343" },
      ].map(({ id, x1, y1, x2, y2 }) => (
        <linearGradient
          key={id}
          id={id}
