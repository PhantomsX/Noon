...
const ContactInfoSection = () => {
  const socials = [
    { icon: instagram, href: "https://www.instagram.com/nnc_ksa/profilecard/?igsh=MWpwa3F1YXkzMm5nYg==" },
    { icon: XIcon, href: "#" },
  ...
  return (
    <section className="w-full bg-black py-24 px-8 md:px-16 lg:px-24 border-t border-[#C6A87D]/20">
      <div className="max-w-7xl mx-auto flex flex-col gap-16">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
            ...
            >
                ...
                <div className="flex flex-col font-neue-montreal text-sm md:text-base text-gray-300 gap-1 mt-2">
                    <p>Al-Madinah, Saudi Arabia Abdusalam</p>
                    <p>Ibn Hafes St, Al Iskan District</p>
                    <p>42317</p>
                    <p>+966598959098</p>
            ...
            >
                ...
                >
                    ...
                    style={{ filter: 'brightness(0) saturate(100%) invert(80%) sepia(28%) saturate(547%) hue-rotate(357deg) brightness(88%) contrast(83%)' }}
                    />
                </a>
                ))}
            </motion.div>
