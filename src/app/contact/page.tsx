  ...
  return (
    <main className="min-h-screen">
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        ...
        >
          {/* Eyebrow */}
          <p className="ltr:font-neue-montreal rtl:font-ibm-plex-arabic text-[#C6A87D]/60 text-xs tracking-[0.2em] uppercase mb-6 flex items-center gap-2 ">
            ...
            {[
              ...
              <div key={text} className="flex items-center gap-3 ">
                <span className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center shrink-0">
                  {icon === "phone" && (
                    <svg
                      className="w-3.5 h-3.5 text-[#C6A87D]/70"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={1.5}
                ...
                <span
                  ...
                  className="ltr:font-neue-montreal rtl:font-ibm-plex-arabic text-gray-300 text-sm"
                >
                  {text}
                </span>
              </div>
