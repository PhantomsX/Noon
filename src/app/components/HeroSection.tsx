...
const HERO_IMAGES = [
  ...
  "/hero/IMAGE-8.jpg", // IMAGE 8 - حطي مسار الصورة هنا
  "/hero/IMAGE-9.jpg", // IMAGE 9 - حطي مسار الصورة هنا
];
  ...
  return (
    <section className="relative w-full h-[calc(100vh-95px)] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Dark overlay عشان الكلام يفضل واضح */}
      ...
      <div className="absolute inset-0 z-20 flex flex-col justify-end px-6 md:px-12 lg:px-20 pb-20 md:pb-28 pointer-events-none">
        {textVisible && (
          <motion.div
            className="rtl:text-right ltr:text-left max-w-3xl pointer-events-auto"
