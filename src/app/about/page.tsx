  ...
  return (
    <main style={afacad.style} className="container mx-auto">
      <motion.section
        ...
        className="mt-20 flex max-lg:flex-col max-lg:items-center gap-6"
      >
        <motion.div
      ...
      <motion.section
        ...
        className="flex-1 my-16 px-3"
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.8, delay: 1.5 }}
          className="flex justify-center flex-wrap items-center gap-y-6 "
        >
          <motion.h3
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 1.7 }}
            className="text-bg italic capitalize mb-4 text-[24px] font-medium shrink-0 lg:hidden"
          >
          ...
          <motion.div
            ...
            className="flex-1 text-white max-md:pb-4 max-w-[500px]"
          >
            <motion.h3
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 2.1 }}
          className="pt-10 md:pt-[78px] grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-8 md:gap-14 *:[&_svg]:shrink-0 text-white"
        >
          <motion.div
